...
public class SqlQueriesConstant {
	...
	public static String GDPR_DEPERSONALIZATION_FETCH = "SELECT CANDIDATE__C, BGC_APPLICATION__c, CATEGORY__C, COUNTRY_CODE__C, "
			...
			+ "PH_WITH_CONSENT_STATUS__C FROM SF_ARCHIVE.GDPR_DEPERSONALIZATION__C WHERE (BGC_STATUS__C = 'Cleared' OR "
			+ "PH_AMAZON_ASSESSMENT_STATUS__C = 'Cleared' OR PH_CANDIDATE_PROVIDED_STATUS__C = 'Cleared' OR "
			+ "PH_MASTER_DATA_STATUS__C = 'Cleared' OR PH_WITH_CONSENT_STATUS__C = 'Cleared') ";		
